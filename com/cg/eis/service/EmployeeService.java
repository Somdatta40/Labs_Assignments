...
public class EmployeeService extends Employee{
	...
	public void displayEmpDetails() {
		...
		if((e.salary>=5000 && e.salary<20000) && e.designation.equalsIgnoreCase("Analyst"))
			e.insuranceScheme="Scheme C";
		else if((e.salary>=20000 && e.salary<40000) && e.designation.equalsIgnoreCase("Senior Analyst"))
